...
import {
  EMBEDDING_MODEL,
  SWARM_MODEL,
  REASONING_DATASET_SCHEMA_VERSION as REASONING_DATASET_SCHEMA_VERSION_VALUE,
  EMBEDDING_TIMEOUT_MS,
  SWARM_CALL_TIMEOUT_MS,
  SWARM_TOTAL_TIMEOUT_MS,
  MAX_TEXT_EMBEDDING_CACHE_ENTRIES,
  PROVIDER_FAILURE_THRESHOLD,
  PROVIDER_COOLDOWN_MS,
  REVIEWED_CALIBRATION_MIN_SIMILARITY,
  MIN_REVIEWED_CORPUS_PROVIDER_POOL,
  MIN_REVIEWED_CORPUS_PROVIDER_MATCHES,
  REVIEWED_CORPUS_PROVIDER_LABEL,
  REVIEWED_PROFILE_MIN_REVIEWED_COUNT,
  REVIEWED_PROFILE_MIN_LABEL_SUPPORT,
  REVIEWED_PROFILE_PROVIDER_LABEL,
  REVIEWED_PROFILE_MERGED_PROVIDER_LABEL,
  STATE_ORDER,
  STRATEGY_ORDER,
  ETHICAL_TERMS,
  CLOSURE_TERMS,
  REFLECTIVE_LANGUAGE_TERMS,
  STATE_LEXICONS,
  STRATEGY_LEXICONS,
  STATE_PROTOTYPES,
  STRATEGY_PROTOTYPES,
...
import {
  ...
  toSoftmaxMap,
  buildSignal,
} from './reasoning/textUtils';

// Re-export public constants so external imports keep working unchanged.
export const REASONING_DATASET_SCHEMA_VERSION = REASONING_DATASET_SCHEMA_VERSION_VALUE;
